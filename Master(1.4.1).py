...
run top-to-bottom — the orchestrator at the bottom executes everything.
    ...
    Stage 1  →  Asteroid Catalog        (Module 1, profitability_pipeline 1.0.4)
    ...
    Stage 4  →  Profitability Calc      (Module 4, CalcPipeline 1.3.4)
...
def run_full_pipeline(master: MasterConfig = None) -> dict:
    ...
    print()
    print("█" * 75)
    print("  🚀  MASTER ASTEROID PROFITABILITY PIPELINE — v1.4.1")
